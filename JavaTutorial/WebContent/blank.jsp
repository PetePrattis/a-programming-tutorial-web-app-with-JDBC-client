...
<head>
  ...
  <title>Java Tutorial - Κεφάλαιο</title>
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Java Tutorial - Κεφάλαιο <%= session.getAttribute("cchapter") %></li>
        </ol>
        ...
        <br> <br>
        <form method="post" action="Tutorial">
			<input class="btn btn-primary" type="submit" name="method" value="<< Previous" style="float: left;">
	  		<input class="btn btn-primary" type="submit" name="method" value="Next >>" style="float: right;">
		</form> 
