...
<head>
  ...
  <title>Java Tutorial - Λάθος δεδομένα</title>
...
<!-- Sidebar -->
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
        <h1 class="display-1">Λάθος δεδομένα</h1>
        <p class="lead">Τα δεδομένα που εισάγατε δεν ήταν έγκυρα ή ήδη χρησιμοποιούνται από άλλον χρήστη (email). Γυρίστε στην
        <a href="javascript:history.back()">προηγούμενη</a>
        σελίδα και ξαναπροσπαθήστε</p>
          <!-- <a href="javascript:history.back()">πίσω</a>
          στη προηγούμενη σελίδα ή να γυρίσετε στην
          <a href="index.jsp">αρχική</a>.</p> -->
